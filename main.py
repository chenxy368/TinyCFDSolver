...
def main():
    ...
    solver = FracStepSolver(0.001, 1000, 0.001, 0.1, 0.1, grid_infomation.u_shape, grid_infomation.v_shape, grid_infomation.p_shape, 
             grid_infomation.u_boundaries, grid_infomation.v_boundaries, grid_infomation.p_boundaries, grid_infomation.u_interior, 
             grid_infomation.v_interior, grid_infomation.p_interior, grid_infomation.u_exterior, grid_infomation.v_exterior, 
             grid_infomation.p_exterior, ploter, animator, 0.9)
    solver.solve(100, 3)
